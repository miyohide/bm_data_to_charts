...
describe ExperimentsController do
  ...
  let(:valid_attributes) { { "experiment_at" => "2014-08-05 22:23:06" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved experiment as @experiment" do
        ...
        post :create, {:experiment => { "experiment_at" => "invalid value" }}, valid_session
        assigns(:experiment).should be_a_new(Experiment)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested experiment" do
        ...
        Experiment.any_instance.should_receive(:update).with({ "experiment_at" => "2014-08-05 22:23:06" })
        put :update, {:id => experiment.to_param, :experiment => { "experiment_at" => "2014-08-05 22:23:06" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the experiment as @experiment" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Experiment.any_instance.stub(:save).and_return(false)
        put :update, {:id => experiment.to_param, :experiment => { "experiment_at" => "invalid value" }}, valid_session
        assigns(:experiment).should eq(experiment)
      end
